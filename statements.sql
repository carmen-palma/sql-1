...
SELECT COUNT(DISTINCT edad) AS diferentes_edades_con_java FROM usuarios_lenguajes WHERE lenguaje = 'Java';
...
SELECT COUNT(*) AS usuarios_con_python FROM usuarios_lenguajes WHERE lenguaje = 'Python';
...
SELECT COUNT(*) AS usuarios_con_css_y_menos_de_30 FROM usuarios_lenguajes WHERE lenguaje = 'CSS' AND edad < 30;

-- Ejercicio 21: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar la cantidad de lenguajes que tienen.
SELECT nombre, COUNT(lenguaje) AS cantidad_de_lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre;
...
SELECT * FROM usuarios_lenguajes WHERE edad < 30 AND lenguaje = (SELECT lenguaje FROM usuarios_lenguajes ORDER BY LENGTH(lenguaje) DESC LIMIT 1);

-- Ejercicio 27: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar sus emails.
SELECT email FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;

-- Ejercicio 28: Contar cuántos usuarios tienen un apellido que comienza con la letra 'G'.
SELECT COUNT(*) AS usuarios_con_apellido_g FROM usuarios_lenguajes WHERE apellido LIKE 'G%';
...
SELECT nombre, MIN(LENGTH(lenguaje)) AS longitud_lenguaje FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' GROUP BY nombre;

-- Ejercicio 30: Encontrar el usuario con edad mayor a 30 y que sabe el lenguaje con menos caracteres.
SELECT * FROM usuarios_lenguajes WHERE edad > 30 AND lenguaje = (SELECT lenguaje FROM usuarios_lenguajes ORDER BY LENGTH(lenguaje) ASC LIMIT 1);
...
SELECT COUNT(*) AS usuarios_de_20_a_25_con_lenguaje FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25 AND lenguaje IS NOT NULL;
...
SELECT nombre, edad, (edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) AS diferencia_edad_promedio FROM usuarios_lenguajes;
...
SELECT COUNT(*) AS usuarios_con_lenguaje_P_y_menos_de_28 FROM usuarios_lenguajes WHERE lenguaje LIKE 'P%' AND edad < 28;